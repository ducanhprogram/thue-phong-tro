...
import { fetchPostsLimit, clearError, clearPosts } from "@/features/posts/postSlice";
...
const List = () => {
    ...
    // Sync currentPage với URL khi component mount
    useEffect(() => {
    ...
    useEffect(() => {
        dispatch(fetchPostsLimit({ page: currentPage, limit }));
    ...
    return (
        <div className={clsx("w-full p-2 shadow-md bg-white rounded-md")}>
            <div className="flex items-center justify-between my-3">
                ...
                <span className="text-sm">Cập nhật: 12:09 25/08/2022</span>
            </div>
            ...
            {/* {pagination?.totalItems > 0 && (
                <div className="my-3 text-sm text-gray-600">
                    Hiển thị {(currentPage - 1) * limit + 1} - {Math.min(currentPage * limit, pagination.totalItems)}
                    trên tổng số {pagination.totalItems} tin đăng
                </div>
            )} */}
